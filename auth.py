...
class Auth:
    ...
    __client_id = '8c3b128d72424bfab40acb26b46f634f'
    __client_secret = '6f5971c1396a4c8e900bb634714d5273'
    __server = 'localhost'
    __port = 8080
    ...
    __scope = ['user-top-read','user-read-email', 'user-read-email', 'user-top-read']
